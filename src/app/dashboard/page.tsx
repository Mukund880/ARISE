    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 text-center md:text-left mb-6 md:mb-0">
          ...
          <div className="w-[130px] h-[130px] shrink-0 bg-primary/5 rounded-2xl border border-primary/20 shadow-inner overflow-visible relative flex items-center justify-center z-10 p-2">
            <AriseMascot size={120} global={true} interactive={true} />
          </div>
          <div>
