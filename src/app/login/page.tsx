...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDFBF7] text-slate-800 relative overflow-hidden px-4">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-indigo-200/20 blur-[130px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-cyan-200/20 blur-[130px] rounded-full pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8 mt-6">
          ...
          <p className="text-slate-500 text-xs">Resume your study roadmap and claim daily XP.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="text-xs text-indigo-500 hover:text-indigo-600 transition-colors font-medium">
                Forgot password?
              </Link>
            </div>
            <Input 
          ...
          <Button type="submit" disabled={loading} className="w-full h-12 bg-indigo-600 hover:bg-indigo-750 text-white font-bold text-sm rounded-xl active:scale-[0.98] transition-transform arbuttonchunky">
        ...
        <div className="mt-6 flex items-center justify-center space-x-3">
          ...
          <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Or login with</span>
          <div className="flex-1 h-px bg-slate-200" />
        </div>
